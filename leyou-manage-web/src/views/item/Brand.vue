        ...
        >
            <template slot="items" slot-scope="props">
                ...
                <td class="justify-center layout px-0">
                    <v-btn icon class="warning" @click="editBrand(props.item)">
                        <i class="el-icon-edit"/>
                    </v-btn>
                    <v-btn icon class="info" @click="deleteBrand(props.item)">
    ...
    export default {
        ...
        watch: {
            pagination: { // 监视pagination属性的变化
                ...
                handler() {
                    ...
                    //判断一下，如果是all,rows默认为-1，所以我们要判断一下
        ...
        methods: {
            ...
            deleteBrand(oldBrand) {
                ...
                this.$message.confirm("您确定要删除吗？").then(resp => {

                    // 根据品牌信息查询商品分类
                    this.$http.delete("/item/brand/deleteBrandById?id=" + oldBrand.id)
                        .then(({data}) => {
